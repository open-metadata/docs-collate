...
{% partial file="/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/messaging/redpanda/yaml"} /%}
...
{% partial file="/connectors/messaging/configure-ingestion.md" /%}
