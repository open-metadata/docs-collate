...
{% partial file="/connectors/yaml/query-usage.md" variables={connector: "postgres"} /%}

{% partial file="/connectors/yaml/lineage.md" variables={connector: "postgres"} /%}

{% partial file="/connectors/yaml/data-profiler.md" variables={connector: "postgres"} /%}
