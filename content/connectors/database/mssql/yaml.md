...
{% partial file="/connectors/yaml/query-usage.md" variables={connector: "mssql"} /%}

{% partial file="/connectors/yaml/lineage.md" variables={connector: "mssql"} /%}

{% partial file="/connectors/yaml/data-profiler.md" variables={connector: "mssql"} /%}
