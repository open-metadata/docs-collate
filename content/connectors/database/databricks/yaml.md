...
{% partial file="/connectors/yaml/query-usage.md" variables={connector: "databricks"} /%}

{% partial file="/connectors/yaml/lineage.md" variables={connector: "databricks"} /%}

{% partial file="/connectors/yaml/data-profiler.md" variables={connector: "databricks"} /%}
