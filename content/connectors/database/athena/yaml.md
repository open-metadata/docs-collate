...
{% partial file="/connectors/yaml/query-usage.md" variables={connector: "athena"} /%}

{% partial file="/connectors/yaml/lineage.md" variables={connector: "athena"} /%}

{% partial file="/connectors/yaml/data-profiler.md" variables={connector: "athena"} /%}
