...
{% partial file="/connectors/yaml/query-usage.md" variables={connector: "snowflake"} /%}

{% partial file="/connectors/yaml/lineage.md" variables={connector: "snowflake"} /%}

{% partial file="/connectors/yaml/data-profiler.md" variables={connector: "snowflake"} /%}
