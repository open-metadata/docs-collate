...
{% partial file="/connectors/yaml/dbt/dbt-prefix-def.md" /%}

{% partial file="/connectors/yaml/dbt/source-config-def.md" /%}
...
{% partial file="//connectors/yaml/dbt/dbt-prefix.md" /%}

{% partial file="//connectors/yaml/dbt/source-config.md" /%}
